...
const TOOL_CATEGORIES = [
  ...
  },
  {
    ...
    name: '视频',
    tools: [
      { name: '视频格式转换', href: '/video-converter', description: '转换视频格式', comingSoon: true },
      { name: '视频压缩', href: '/video-compress', description: '压缩视频文件', comingSoon: true },
      { name: '视频剪辑', href: '/video-editor', description: '在线视频剪辑', comingSoon: true },
    ],
  },
  {
    id: 'audio',
    name: '音频',
    tools: [
      { name: '音频格式转换', href: '/audio-converter', description: '转换音频格式', comingSoon: true },
      { name: '音频剪辑', href: '/audio-editor', description: '在线音频剪辑', comingSoon: true },
      { name: '音频合并', href: '/audio-merge', description: '合并多个音频', comingSoon: true },
    ],
  },
  {
    id: 'image',
    name: '图像',
    tools: [
      { name: '图片格式转换', href: '/image-converter', description: 'JPG/PNG/WebP转换', comingSoon: true },
      { name: '图片压缩', href: '/image-compress', description: '压缩图片大小', comingSoon: true },
      { name: '图片裁剪', href: '/image-crop', description: '裁剪图片', comingSoon: true },
      { name: '批量水印', href: '/image-watermark', description: '批量添加水印', comingSoon: true },
    ],
  },
  {
    id: 'pdf',
    name: 'PDF文档',
    tools: [
      { name: 'PDF合并', href: '/pdf-merge', description: '合并多个PDF文件', comingSoon: true },
      { name: 'PDF拆分', href: '/pdf-split', description: '拆分PDF页面', comingSoon: true },
      { name: 'PDF转图片', href: '/pdf-to-image', description: 'PDF转换为图片', comingSoon: true },
      { name: '图片转PDF', href: '/image-to-pdf', description: '图片转换为PDF', comingSoon: true },
    ],
  },
];
